...
var IndecisionApp = function (_React$Component) {
  ...
  function IndecisionApp(props) {
    ...
    _this.handleAddHere = _this.handleAddHere.bind(_this);
    _this.state = {
      options: []
    };
    return _this;
  ...
  _createClass(IndecisionApp, [{
    ...
    value: function handlePick() {
      var randNumber = Math.trunc(Math.random() * this.state.options.length);
      var option = this.state.options[randNumber];
      alert(option);
    }
  }, {
    key: "handleAddHere",
    value: function handleAddHere(option) {
      // console.log(option);
      if (!option) {
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(AddOption, { handleAddHere: this.handleAddHere })
      );
    }
  }]);
...
var AddOption = function (_React$Component5) {
  ...
  _createClass(AddOption, [{
    ...
    value: function handleAddOption(e) {
      ...
      var error = this.props.handleAddHere(option);
